  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless healthcare with Patient Management - Your trusted partner for maintaining comprehensive patient history records"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1599045118108-bf9954418b76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtZWRpY2FsJTIwcmVjb3Jkc3xlbnwwfHx8fDE2OTYzMTU1MTl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@haloirwan?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Irwan @blogcious`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless healthcare with Patient Management - Your trusted partner for maintaining comprehensive patient history records`}
            </Text>
            <Box
